-- Corrected Sybase Setup Script for ASE
...
-- Check if table has data and insert sample data
IF NOT EXISTS (SELECT * FROM employees WHERE id = 1)
BEGIN
    INSERT INTO employees (id, name, dept, salary) VALUES (1, 'Alice', 'HR', 55000.00)
    INSERT INTO employees (id, name, dept, salary) VALUES (2, 'Bob', 'IT', 75000.00)
    INSERT INTO employees (id, name, dept, salary) VALUES (3, 'Charlie', 'Finance', 62000.00)
